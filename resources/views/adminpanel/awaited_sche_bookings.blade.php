                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="search_form" method="GET" action="{{ route($route) }}">
                                    @csrf
									...
									<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"><!--buttons-->
									   ...
									   <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
												<a href="{{ route($route) }}" style="margin-top: 32px;"
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_{{ $pencil['id'] }}">
                                            ...
                                            <td id="photographer_name_{{ $pencil['id'] }}">
                                                @if($pencil['collected_by_photographer']==1)
                                                    
                                                    <span class=" btn-info btn-sm">Collect {{$pencil['photographer_to_collect_amount']>0?'$'.$pencil['photographer_to_collect_amount']:''}} Payment {{$pencil['photographer_payee_name']!=''?'from'.$pencil['photographer_payee_name']:''}}</span>
                                                @else 
                                                            NO
                                                @endif
                                                {{-- <span class="badge badge-info">{{booking_status($pencil['status'])}}</span> --}}
                                            </td>
                                            <td>
