...
@endsection
@section('head-js-css')
    {{-- Calender  JS CSS for header --}}
     <!-- fullCalendar -->
  <link rel="stylesheet" href="{{ url('adminpanel/plugins/fullcalendar/main.css')}}">
@endsection

@section('footer-js-css')
{{-- Calender Js CSS for Footer --}}
<!-- fullCalendar 2.2.5 -->
<script src="{{url('adminpanel/plugins/moment/moment.min.js')}}"></script>
<script src="{{url('adminpanel/plugins/fullcalendar/main.js')}}"></script>
<script>
    $(function () {
