                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3">
                                            <select name="patient_type" class="form-control form-control-lg">
                                                ...
                                                <option value="emergncy">Emeergeency</option>
                                            </select>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                @php
                                                                    ...
                                                                    //     foreach($advisedTests as $data){
                                                                            
                                                                    //         p(getReportByTestId($data));
                                                                    //         break;
                                                                    //     }
                                                                ...
                                                                <select  name="advised_tests[]"
                                                                    ...
                                                                    foreach ($LabTestsDataWithParams as $testData) {
                                                                           ...
                                                                           $data[]= $patientReport=getReportByTestId($testData['id']);
                                                                            ...
                                                                            foreach ($patientReport as $key => $params) {
                                                                                ...
                                                                                $htmlElement .= '<div class="col-3"><input value=' . $params['parameter_name'] . ' disabled type="text" class="form-control" ></div>';
                                                                                $htmlElement .= '<div class="col-2">';
                                                                                if ($params['parameter_result'] == 'input') {
                                                                                    $htmlElement .= '<input required="required" value="'.$params['param_result']['lab_test_param_result'].'" type="text" name="lab_test_param_result[' . $params['param_result']['id'] . '][]" class="form-control" placeholder="Enter Result (e.g 894)">';
                                                                                } else {
                                                                                    $htmlElement .= '<select required="required" name="lab_test_param_result[' . $params['param_result']['id'] . '][]" class="form-control" placeholder="Select one">';
                                                                                        
                                                                                        $pos='';
                                                                                        $neg='selected';
                                                                                        if($params['param_result']['lab_test_param_result']=='Pos'){
                                                                                            $pos='selected';
                                                                                            $neg='';
                                                                                        }
                                                                                ...
                                                                                $htmlElement .= '</div>';
                                                                                $htmlElement .= '<div class="col-2">';
                                                                                $htmlElement .= '<input value=' . $params['parameter_unit'] . ' disabled type="text" class="form-control">';
                                                                                $htmlElement .= '</div>';
                                                                                $htmlElement .= '<div class="col-2">';
                                                                                $htmlElement .= '<input value=' . $params['parameter_normal_range'] . ' disabled type="text" class="form-control" >';
                                                                                $htmlElement .= '</div>';
                                                                                $htmlElement .= '<div class="col-3">';
                                                                                $htmlElement .= '<input value=' . $params['comments'] . ' disabled type="text" class="form-control" >';
                                                                                $htmlElement .= '</div>';
                                                                                $htmlElement .= '</div>';
                                                                            }
                                                                            $htmlElement .= '</div>';
                                                                            ...
                                                                            foreach ($testData['get_params'] as $key => $params) {
                                                                                ...
                                                                                $htmlElementHidden .= '<div class="col-3"><input type="text" value="'.$params['parameter_name'].'" class="form-control" disabled > </div>';
                                                                                $htmlElementHidden .= '<div class="col-2">';
                                                                                if ($params['parameter_result'] == 'input') {
                                                                                    $htmlElementHidden .= '<input required="required" type="text" name="lab_test_param_result[' . $params['id'] . '][]" class="form-control" placeholder="Enter Result (e.g 894)">';
                                                                                } else {
                                                                                ...
                                                                                $htmlElementHidden .= '<div class="col-2">';
                                                                                $htmlElementHidden .= '<input value=' . $params['parameter_unit'] . ' disabled type="text" class="form-control">';
                                                                                $htmlElementHidden .= '</div>';
                                                                                $htmlElementHidden .= '<div class="col-2">';
                                                                                $htmlElementHidden .= '<input value=' . $params['parameter_normal_range'] . ' disabled type="text" class="form-control" >';
                                                                                $htmlElementHidden .= '</div>';
                                                                                $htmlElementHidden .= '<div class="col-3">';
                                                                                $htmlElementHidden .= '<input value=' . $params['comments'] . ' disabled type="text" class="form-control" >';
                                                                                $htmlElementHidden .= '</div>';
                                                                                $htmlElementHidden .= '</div>';
                                                                            }
                                                                            $htmlElementHidden .= '</div>';
