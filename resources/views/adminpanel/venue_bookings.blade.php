...
@push('title')
    <title>
        Venue Bookings| {{ config('constants.app_name') }}</title>
@endpush
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <form id="search_form" method="GET" action="{{ route($route,$type) }}">
                                    ...
                                    <input type="hidden" id="venue_groups_id" name="venue_groups_id[]" value="{{$user->id}}">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            ...
                                            echo '<tr><td class="text-center" colspan="7">No Record Found</td></tr>';
                                        }
                                        ?>
