...
@push('title')
    <title>Add Customers | {{ config('constants.app_name') }}</title>
@endpush
                              ...
                              <div class="row">
                                ...
                                <form method="POST" action="{{ url('/admin/customers/add') }}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group mb-3 ">
                                              ...
                                              class="form-control select2bs4" placeholder="Select Customers Type">
                                              @php
                                                 $selectedID=old('leads_type'); 
                                                //  if($selectedID==$key)
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                            <select id="city" onChange="changeCity()" name="city" class="form-control select2bs4" placeholder="Select Venue Group">@php echo getCitiesOptions(); @endphp</select>
                                            </div>
                                        </div>
                                        <div class="col-3">&nbsp;</div>
                                    </div>
