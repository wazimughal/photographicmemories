        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-2"><a style="width:60%" href="{{ url('/admin/bookings/place/') }}"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_{{ $data['id'] }}">
                                            ...
                                            <td id="photographer_name_{{ $data['id'] }}">Photo</td>

                                            <td>

                                                <a href="{{url('admin/bookings/edit')}}/{{$data['id']}}" class="btn btn-info btn-block btn-sm"><i class="fas fa-edit"></i>
                                                    Edit</a>
