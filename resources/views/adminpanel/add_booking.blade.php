                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ url('/admin/bookings/place') }}">
                                    ...
                                    if((isset($id) && $id>0)){
                                        ...
                                        echo '<input type="hidden" name="customer_id" value="'.get_session_value('id').'">';
                                    }
                                    ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="input-group mb-3">
                                                <input placeholder="First Name" type="text" name="groom_first_name"
                                                    required value="{{ old('groom_first_name') }}"
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="input-group mb-3" style="margin-top:2rem;">
                                                <input required value="{{ old('groom_last_name') }}" placeholder="Last Name"
                                        ...
                                        <div class="col-5">
                                            <div class="input-group mb-3">
                                                <input placeholder="Phone Number" type="text" name="groom_contact_number"
                                                    required value="{{ old('groom_contact_number') }}"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="input-group mb-3">
                                                <input placeholder="First Name" type="text" name="bride_first_name"
                                                    required value="{{ old('bride_first_name') }}"
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="input-group mb-3" style="margin-top:2rem;">
                                                <input required value="{{ old('bride_last_name') }}"
                                        ...
                                        <div class="col-5">
                                            <div class="input-group mb-3">
                                                <input placeholder="Phone Number" type="text"
                                                    ...
                                                    value="{{ old('bride_contact_number') }}"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="input-group date" id="reservationdatetime"
                                                ...
                                                <input name="event_date_time"
                                                    placeholder="Event Date & Time (09/22/2022 2:25 AM)"
                                                    value="{{ old('event_date_time') }}" type="text"
                                        ...
                                        <div class="col-2">
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    {{-- <input type="hidden" name="pacakge_id" value="{{$packageData['id']}}"> --}}
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-10">
                                            <div class="input-group mb-3">
                                                <textarea placeholder="Any Special Notes for this order.." name="order_notes"
