                    ...
                    <div class="col-12">
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('pencils.save_user_pencils_data') }}">
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        <div class="col-3">&nbsp;</div>
                                        <div class="col-6">
                                            <label>Email</label><span> [{{ $user->email}}] Leave it empty if you don't want to change </span><br>
                                            {{-- <label>Email</label> --}}
                                            <div class="input-group mb-3">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-3">&nbsp;</div>
                                        <div class="col-6">
                                            <label>Relation with event</label>
                                            <div class="input-group mb-3">
